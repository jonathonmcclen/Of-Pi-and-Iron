...
<tileset name="CityWalls3 E" tilewidth="16" tileheight="16" tilecount="256" columns="16">
 <image source="Images/Set_E_CityWalls3.png" trans="ff01fe" width="256" height="256"/>
 <terraintypes>
  <terrain name="Top1" tile="17"/>
  <terrain name="Top2" tile="65"/>
  <terrain name="Top3" tile="5"/>
  <terrain name="Floor" tile="96"/>
  <terrain name="Cobblestones" tile="8"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
