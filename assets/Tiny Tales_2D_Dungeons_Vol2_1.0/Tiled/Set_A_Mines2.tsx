...
<tileset name="Mines2" tilewidth="16" tileheight="16" tilecount="256" columns="16">
 <image source="Images/Set_A_Mines2.png" trans="ff01fe" width="256" height="256"/>
 <terraintypes>
  <terrain name="Walls1" tile="17"/>
  <terrain name="Walls2" tile="20"/>
  <terrain name="Top" tile="65"/>
  <terrain name="Road 1" tile="96"/>
  <terrain name="Road 2" tile="144"/>
  <terrain name="Elevation" tile="192"/>
  <terrain name="Water" tile="25"/>
  <terrain name="Water 2" tile="169"/>
  <terrain name="Pit" tile="200"/>
 </terraintypes>
 <tile id="0" terrain=",,,0"/>
